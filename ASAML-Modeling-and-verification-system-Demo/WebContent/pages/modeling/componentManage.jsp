    ...
    <body>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">添加组件类型</h4>
		      </div>
		      	...
		      	<form class="form-horizontal" >
		      		<fieldset>
					    ...
					    <div class="form-group" id="paraDiv_1">
						  	<label for="inputPara" class="col-sm-3 control-label">接口1</label>
						  	<div class="col-md-6">
		...
		$("#addPara").click(function(e){
        	...
        	var str = '<div class="form-group" id="paraDiv_'+(Number(i)+1)+'">'+
			  				'<label for="inputPara" class="col-sm-3 control-label">接口'+(Number(i)+1)+'</label>'+
			  				'<div class="col-md-6">'+
        ...
        var a = function(p) {
		 ...
		 function getDemandList(proId){
	        	$.ajax({
					...
					data : JSON.stringify({level:4,projectId:proId}),
					success : function(data) {
						$("#demandList").empty();
						if (data.errorcode == 1000) {
        ...
        function getTypeInterfaceList(){
        	$.ajax({
				...
				data : JSON.stringify({limit:limit,page:page,keyword:keyword,level:4}),
				success : function(data) {
						...
						if(total){
							...
							$(".editTypeInterface").click(function(){
								...
								$.ajax({
									...
									data:JSON.stringify({id:bid,level:4}),
